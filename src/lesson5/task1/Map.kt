...
/**
 */
fun helper(friends: Map<String, Set<String>>, set: Set<String>): Set<String> {
    val result = mutableSetOf<String>()
    for (i in set) {
        if (friends[i] != null) result += friends[i]!!
    }
    return if (set.containsAll(result)) set
    else helper(friends, result + set)
}
